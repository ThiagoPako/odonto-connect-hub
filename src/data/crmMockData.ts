...
export const mockPatients: Patient[] = [
  { id: "p1", name: "Maria Silva", initials: "MS", phone: "+55 11 99999-1001", email: "maria@email.com", origin: "Google Ads", status: "paciente", lastVisit: new Date(Date.now() - 7 * 86400000), createdAt: new Date(Date.now() - 90 * 86400000), totalSpent: 8500, avatarColor: "bg-chart-2" },
  { id: "p2", name: "Carlos Oliveira", initials: "CO", phone: "+55 11 99999-1002", email: "carlos@email.com", origin: "Instagram", status: "lead", createdAt: new Date(Date.now() - 3 * 86400000), totalSpent: 0, avatarColor: "bg-chart-1" },
  ...
  { id: "p6", name: "Pedro Costa", initials: "PC", phone: "+55 11 99999-1005", email: "pedro@email.com", origin: "Site", status: "lead", createdAt: new Date(Date.now() - 1 * 86400000), totalSpent: 0, avatarColor: "bg-dental-cyan" },
  ...
  { id: "p8", name: "João Santos", initials: "JS", phone: "+55 11 99999-1008", email: "joao@email.com", origin: "Meta Ads", status: "inativo", lastVisit: new Date(Date.now() - 90 * 86400000), createdAt: new Date(Date.now() - 300 * 86400000), totalSpent: 4500, avatarColor: "bg-chart-2" },
];
