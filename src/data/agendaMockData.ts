...
export const mockAppointments: Appointment[] = [
  { id: "a1", patientName: "Maria Silva", patientInitials: "MS", avatarColor: "bg-chart-2", professional: "Dr. Ricardo Mendes", professionalInitials: "RM", room: "Sala 1", procedure: "Implante unitário", date: "08/04/2026", time: "08:00", duration: 90, status: "finalizado", phone: "+55 11 99999-1001", confirmed: true },
  { id: "a2", patientName: "Carlos Oliveira", patientInitials: "CO", avatarColor: "bg-chart-1", professional: "Dra. Ana Souza", professionalInitials: "AS", room: "Sala 2", procedure: "Manutenção ortodôntica", date: "08/04/2026", time: "08:30", duration: 30, status: "em_atendimento", phone: "+55 11 99999-1002", confirmed: true },
  ...
  { id: "a6", patientName: "Pedro Costa", patientInitials: "PC", avatarColor: "bg-dental-cyan", professional: "Dra. Ana Souza", professionalInitials: "AS", room: "Sala 2", procedure: "Instalação aparelho", date: "08/04/2026", time: "11:00", duration: 60, status: "aguardando", phone: "+55 11 99999-1005", confirmed: true },
  ...
  { id: "a8", patientName: "João Santos", patientInitials: "JS", avatarColor: "bg-chart-2", professional: "Dr. Ricardo Mendes", professionalInitials: "RM", room: "Sala 1", procedure: "Carga imediata", date: "08/04/2026", time: "14:00", duration: 120, status: "confirmado", phone: "+55 11 99999-1008", confirmed: true },
